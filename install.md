# Ecommerce Customer Churn Prediction guide installation

## Activate environment

```bash
Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope Process
.\`ecommerce_customer_churn_prediction`\venv\Scripts\activate
...
```python
from ecommerce_customer_churn_prediction.utils.paths import data_dir
data_dir()
```
